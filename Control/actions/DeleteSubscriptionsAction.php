...
if (isset($_GET['id'])) {
    ...
    // Appeler la fonction deleteabonnement pour supprimer l'annonce
    deleteabonnement($id_a_supprimer);

    // Exécuter un script JavaScript pour recharger la page
    echo '<script>window.location.href = "/crud+back+c_d_v/View/front/gerercours.php";</script>';
}
...
function deleteabonnement($id) {
   ...
   $sql = "DELETE FROM abonnements WHERE IdAbonnement = :id";
