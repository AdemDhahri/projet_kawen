...
if (isset($_POST['submit'])) {
    ...
    $NewCours = new cours(null,$Titre,$Description,$Categorie,$Format,$DatePost,$DateExpir,$Langue,$Prix,$CompetencesAcquises,$Prerequis,$Certification,$Support);
...
function createcours(cours $jobD)
{
    ...
    $sql = "INSERT INTO cours (Titre ,Description ,Categorie ,Format ,DatePost ,DateExpir, Langue, Prix, CompetencesAcquises, Prerequis, Certification,Support) 
                VALUES (:Titre ,:Description ,:Categorie ,:Format ,:DatePost ,:DateExpir, :Langue, :Prix, :CompetencesAcquises, :Prerequis, :Certification, :Support)";
