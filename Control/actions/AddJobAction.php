...
if (isset($_POST['submit'])) {
    ...
    $recruter_tel = htmlspecialchars($_POST['telephone']);
     $recruter_ville = htmlspecialchars($_POST['ville']);
    $cv = htmlspecialchars($_POST['cv']);
    $ldm = htmlspecialchars($_POST['lettre_motivation']);
    $message = htmlspecialchars($_POST['message']);
    $NewRecruiter = new chercheurs(null,$recruter_Surname,$recruter_name,$recruter_mail,$recruter_tel,$recruter_ville,$cv,$ldm,$message);
...
function createchercheur(chercheurs $jobD)
{
    ...
    $sql = "INSERT INTO chercheurs (nom ,prenom ,mail ,tel ,ville ,cv ,l_d_v ,message) 
                VALUES (:nom, :prenom, :mail, :tel, :ville, :cv, :l_d_v, :message)";
