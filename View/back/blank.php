        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                     <!-- Formulaire de tri -->
                <form action="../../Control/actions/triParDatePostCours.php" method="GET">
                    <label for="tri">Trier par date de publication :</label>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $cours['Categorie']; ?></td>
                            <td><?php echo $cours['Format']; ?></td>
                            <td><?php echo $cours['DatePost']; ?></td>
                            <!-- Ajoutez d'autres colonnes au besoin -->
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                    ...
                    <h1 class="h3 mb-4 text-gray-800">Les cours publiés</h1>
