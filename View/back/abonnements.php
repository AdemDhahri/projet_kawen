...
include('../../View/back/deletebackabonnement.php');
            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages" class="collapse show" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item " href="blank.php">Les cours publiés</a>
                        <a class="collapse-item " href="abonnements.php">Les abonnements publiés</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1>Liste des abonnements par cours</h1>
                    
                    <!-- Formulaire pour saisir l'ID du cours -->
                    <form action="../../Control/actions/RechercheAbCours.php" method="POST">
                        <label for="idCours">ID du cours :</label>
                        <input type="text" name="idCours" id="idCours">
                        <input type="submit" value="Rechercher">
                    </form>

                    <?php if(isset($abonnements) && !empty($abonnements)): ?>
                        <h2>Abonnements pour le cours <?php echo $idCours; ?>:</h2>
                        <ul>
                            <?php foreach($abonnements as $abonnement): ?>
                                <li><?php echo $abonnement['IdAbonnement']; ?> - <?php echo $abonnement['DateFin']; ?></li>
                            <?php endforeach; ?>
                        </ul>
                    <?php elseif(isset($abonnements) && empty($abonnements)): ?>
                        <p>Aucun abonnement trouvé pour le cours avec l'ID <?php echo $idCours; ?></p>
                    <?php endif; ?>

                    <h1 class="h3 mb-4 text-gray-800">Les abonnements publiés</h1>
...
<!-- "< ?= ?>" => echo/afficher -->
    ...
    <a class="btn btn-secondary me-3" href="../../View/back/deletebackabonnement.php?id=<?= $AbonnementK['IdAbonnement']; ?>" name="delete_id" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet abonnement ?');">Supprimer</a>
</div>
