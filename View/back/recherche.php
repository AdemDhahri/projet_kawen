...
$liste = $CUser->afficherClients();// Vérifier si le formulaire de recherche a été soumis
if(isset($_POST['search'])) {
    // Vérifier si l'ID de l'utilisateur a été fourni
    if(isset($_POST['userId'])) {
        ...
        // Récupérer les détails de l'utilisateur à partir de la base de données en utilisant la fonction recupererClient
        $userDetails = $CUser->recupererClient($userId);
...
<body id="page-top">
    ...
    <input type="text" name="userId" id="userId" placeholder="Search user by ID...">
...
<script>
    document.getElementById("modifyBtn").addEventListener("click", function() {
        ...
        window.location.href = "modify.php?userId=" + userId;
    });
</script>
...
<div id="userDetails">
    ...
    // Vérifier si les détails de l'utilisateur ont été trouvés
    if (!empty($userDetails)) {
        ...
        echo "<tr><td colspan='8'>Utilisateur non trouvé.</td></tr>";
    }
    ?>
</tbody>
