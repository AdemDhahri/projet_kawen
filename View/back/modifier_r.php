                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    ...
                                    <input type="text" value="<?php echo $reclam['tel'] ?>" class="form-control" id="phone" name="phone" placeholder="phone" >
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-floating">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    ...
                                    <textarea class="form-control" placeholder="Leave a message here" id="description" name="description" style="height: 150px" required>
                                        <?php echo htmlspecialchars($reclam['message']) ?>
                                    </textarea>
                                </div>
                            </div>
            
<div class="col-12 text-center mt-4">
    <input type="submit" class="btn btn-primary btn-lg py-3" value="Modifier la réclamation">
</div>
```
