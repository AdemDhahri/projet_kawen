...
if (isset($_GET['id'])) {
    ...
    $reclamation = $reclamationsC->getreclamationeById($rec_id);
}
?>
            ...
            <div class="container my-5 pt-5 pb-4">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb text-uppercase">
                        ...
                        <li class="breadcrumb-item text-white active" aria-current="page">Details de votre réclamation</li>
                    </ol>
                </nav>
            </div>
        </div>
        <!-- Header End -->
<!-- Remplacer la section Job Detail par le code QR -->
<div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
    <div class="container">
        <div class="row gy-5 gx-4 justify-content-center"> <!-- Utilisation de justify-content-center pour centrer horizontalement -->
            <div class="col-lg-8 text-center"> <!-- Ajout de la classe text-center pour centrer le contenu -->
                ...
                $email = $reclamation['mail'];
                $telephone = $reclamation['tel'];
                $retour = $reclamation['retour'];
                $etat = $reclamation['etat'];

                // Chaîne de texte à encoder dans le code QR
                $qr_text = "Nom: $nom \n Objet: $objet \n Message: $message \n Date: $date \n Email: $email \n Téléphone: $telephone \n Retour: $retour \n État de la réclamation: $etat";

                // Générer le code QR
                QRcode::png($qr_text, '../../assests/front/img/bf.png', QR_ECLEVEL_L, 10, 2);

                // Afficher le code QR au centre de la page
                echo '<img src="../../assests/front/img/bf.png" alt="Code QR" class="mx-auto">';
                ?>
                <!-- Fin du code QR -->
            </div>
        </div>
