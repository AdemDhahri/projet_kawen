...
{
    $CUser->supprimerClient($_POST["nom_comp"]);
...
if (isset($_POST['x'])) {
    ...
    if (!empty($_POST['nom_comp']) && !empty($_POST['adresse_mail']) && !empty($_POST['mdp']) && !empty($_POST['rep1']) && !empty($_POST['rep2']) && !empty($_POST['rep3'])) {
        ...
        $user = new User($nom_comp, $adresse_mail, $mdp, $rep1, $rep2, $rep3);
    ...
    <div class="form-container">
        ...
        <div class="form-inner">
            <form action="#" method="post" class="login">
                <div class="field">
                    <input type="text" name="nom_comp" placeholder="Nom de l'utilisateur à supprimer" required />
                </div>
                <div class="field btn">
