                ...
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            <a href="job-list.php" class="dropdown-item"><?php 
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            <a href="job-list.php" class="dropdown-item active"><?php 
include('../../Model/chercheur.php');
include('../../Control/actions/AddJobAction.php');
...
<div class="container py-5">
    ...
    <form  method="post">
        ...
        <div class="mb-3">
            <button type="submit" name="submit" class="btn btn-primary">Publier Annonce</button>
        </div>
    </form>
</div>
    ...
    <script src="../../assests/front/js/main.js"></script>
                            ...
                            <a href="job-detail.php" class="dropdown-item">les chercheurs</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
