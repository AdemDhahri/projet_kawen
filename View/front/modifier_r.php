...
if (isset($_GET['id'])) {
    ...
    $reclam = $reclamationC->getreclamationeById($reclam_id);
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (
        ...
        if ($reclamationC->updatereclamation($reclam_id, $reclamm)) {
            $success = true;
            unset($_POST);
    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5 bg-dark page-header mb-5">
            <div class="container my-5 pt-5 pb-4">
                <h1 class="display-3 text-white mb-3 animated slideInDown">Modifier réclamation</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb text-uppercase">
                        <li class="breadcrumb-item text-white active" aria-current="page">Modifier réclamation </li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Modifier réclamation</h1>
                <?php
                if (!empty($error))
    ...
    <div class="row g-3">
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" value="<?php echo $reclam['nom'] ?>" class="form-control" id="nom" name="nom" placeholder="Nom" required>
        ...
        <div class="col-md-6">
            <div class="form-floating">
                <input type="email" value="<?php echo $reclam['mail'] ?>" class="form-control" id="mail" name="mail" placeholder="Your Email" required>
                <label for="mail">Mail</label>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" value="<?php echo $reclam['tel'] ?>" class="form-control" id="phone" name="phone" placeholder="Téléphone" required>
        ...
        <div class="col-md-6">
            <div class="form-floating">
                <select class="form-select" id="retour" name="retour" aria-label="retour" required>
                    <option value="oui" <?= $reclam["retour"] == 'oui' ? ' selected="selected"' : ''; ?>>Oui</option>
                    <option value="non" <?= $reclam["retour"] == 'non' ? ' selected="selected"' : ''; ?>>Non</option>
                </select>
                <label for="retour">Voudriez-vous avoir un retour</label>
            </div>
        </div>

        <div class="col-12">
            <div class="form-floating">
                <input type="text" value="<?php echo $reclam['objet'] ?>" class="form-control" id="objet" name="objet" placeholder="Objet" required>
                <label for="objet">Objet</label>
            </div>
        </div>
        <div class="col-12">
            <div class="form-floating">
                <textarea class="form-control" placeholder="Leave a message here" id="description" name="description" style="height: 150px" required><?php echo htmlspecialchars($reclam['message']) ?></textarea>
                <label for="description">Message</label>
            </div>
        </div>
        <div class="col-12">
            <input type="submit" class="btn btn-primary w-100 py-3" value="Modifier la réclamation">
        </div>
    </div>
</form>
